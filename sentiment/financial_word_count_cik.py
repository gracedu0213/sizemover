...
This script computes the word count per Central Index Key in a JSON format for visualization.
"""
...
word_count_stats_file = 'financial_word_count_cik_stats.log'
word_count_json_file = 'financial_word_count_cik_stats.json'
